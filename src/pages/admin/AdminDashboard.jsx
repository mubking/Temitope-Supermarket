...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      {/* Sidebar */}
      <div className={`bg-gray-800 text-white md:w-64 flex-shrink-0 ${sidebarOpen ? 'block' : 'hidden md:block'}`}>
        ...
        <nav className="p-2">
          <ul className="space-y-2">
            <li>
              <Link href="/admin" className="block py-2 px-4 rounded bg-gray-700 text-white">
                Dashboard
              </Link>
            </li>
            <li>
              <Link href="/admin/products" className="block py-2 px-4 rounded hover:bg-gray-700 text-gray-300">
                Products
              </Link>
            </li>
            <li>
              <Link href="/admin/orders" className="block py-2 px-4 rounded hover:bg-gray-700 text-gray-300">
                Orders
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/admin/credit-applications" className="block py-2 px-4 rounded hover:bg-gray-700 text-gray-300">
                Credit Applications
              </Link>
            </li>
            <li>
        ...
        <div className="absolute bottom-0 p-4 w-full md:w-64">
